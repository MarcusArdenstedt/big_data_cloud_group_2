...
from dlt_daily_update import job_ad_source
...
dbt_project_directory = Path(__file__).parents[1] / "dbt_job_ads"
...
job_dlt = dg.define_asset_job("job_dlt", selection=dg.AssetSelection.keys("dlt_job_ad_source_jobsearch_resource"))
...
@dg.asset_sensor(asset_key=dg.AssetKey("dlt_job_ad_source_jobsearch_resource"),
                 job_name="job_dbt")
def dlt_load_sensor():
    yield dg.RunRequest()
